...
var ContextMenuComponent = (function () {
    function ContextMenuComponent(_contextMenuService, changeDetector, elementRef, options) {
        ...
        _contextMenuService.hide.subscribe(function () {
            _this.hideMenu();
        });
    }
    ...
    ContextMenuComponent.prototype.onMenuEvent = function (menuEvent) {
        ...
        if (actions && actions.length > 0) {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    var menuWidth = _this.menuElement.nativeElement.clientWidth;
                    var menuHeight = _this.menuElement.nativeElement.clientHeight;
